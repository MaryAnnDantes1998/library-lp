          ...
          <div class="col-md-10">
            ...
            <div class="card card-body">
              <div class="card-header">
                <h3 class="col-xs-6"><span class="fa fa-edit"></span> ARCHIVE E-BOOK</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
  ...
  ?>                       
                        ...
                        <center><h3><strong>You are about to send this lists into "INACTIVE STATUS" </h3></center><br>
                                ...
                                <div class="form-group">
                                    <div class="col-md-8">
                                        <input type="hidden" name="ebook_id" id="last-name2" value="<?php echo $row['ebook_id']; ?>" class="form-control col-md-12 col-xs-12">
                                    </div>
                                </div>
                          ...
                          <option value="<?php echo htmlspecialchars($row['pop_id']); ?>"><?php echo htmlspecialchars($row['placeofpublication']); ?>
                            ...
                            <?php $result= mysqli_query($con,"select * from tbl_placeofpublications ORDER BY placeofpublication") or die (mysql_error());
...
mysqli_query($con," INSERT INTO ebook_archive (ebook_id,call_no,title,subject,author,editor,edition,pop_id,publisher_id,quantity,date_of_publ,series,isbn_no,accession_no,moa_id,issn_no,notation1,notation2,abstract,remarks,page_no,deyt) VALUES ('$ebook_id','$call_no','$title','$subject','$author','$editor','$edition','$place_of_publ','$publisher','$quantity','$date_of_publ','$series','$isbn_no','$accession_no','$moa','$issn_no','$notation1','$notation2','$abstract','$remark','$page_no','$date') ") or die(mysqli_error($con));
